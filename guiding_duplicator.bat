...
echo Please wait till I make the guiding folders... ^>.^<
...
for %%F in ("%source_folder%\*") do (
    ...
    rem Create a folder called "guiding" in the current destination folder
    mkdir "Destination\!folder_count!\%folder_name%\guiding" >nul 2>nul
...
echo "guiding" folders created successfully.
